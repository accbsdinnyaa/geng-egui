...
fn egui_key(geng_key: geng::Key) -> Option<egui::Key> {
    ...
    match geng_key {
        ...
        geng::Key::Semicolon => Some(Semicolon),
        geng::Key::Backquote => Some(Backtick),
        geng::Key::Backslash => Some(Backslash),
        geng::Key::BracketLeft => Some(OpenBracket),
        geng::Key::BracketRight => Some(CloseBracket),
        geng::Key::Comma => Some(Comma),
        geng::Key::Equal => Some(Equals),
        geng::Key::IntlBackslash => Some(Backslash),
        geng::Key::Minus => Some(Minus),
        geng::Key::Period => Some(Period),
        geng::Key::Quote => Some(Quote),
        geng::Key::Slash => Some(Slash),
        geng::Key::Tab => Some(Tab),
        geng::Key::Delete => Some(Delete),
        geng::Key::End => Some(End),
        geng::Key::Home => Some(Home),
        geng::Key::Insert => Some(Insert),
        geng::Key::NumpadBackspace => Some(Backspace),
        geng::Key::NumpadComma => Some(Comma),
        geng::Key::NumpadEnter => Some(Enter),
        geng::Key::NumpadEqual => Some(Equals),
        geng::Key::F1 => Some(F1),
        geng::Key::F2 => Some(F2),
        geng::Key::F3 => Some(F3),
        geng::Key::F4 => Some(F4),
        ...
        geng::Key::F8 => Some(F8),
        geng::Key::F9 => Some(F9),
        geng::Key::F10 => Some(F10),
        geng::Key::F11 => Some(F11),
        geng::Key::F12 => Some(F12),
        _ => None,
    }
}
